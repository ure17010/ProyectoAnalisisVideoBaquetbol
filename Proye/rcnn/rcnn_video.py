# usoo
# python rcnn_video.py -i input/basketball.mp4 -m mask-rcnn-coco
...
ap.add_argument("-o", "--output", required=False, default="output/RCNN.mp4", help="path to output video file")
