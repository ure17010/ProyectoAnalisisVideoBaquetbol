...
# Read source image.
img_src = cv2.imread('images/basketball_nba.jpg')

# Four corners of the 3D court + mid-court circle point in source image
pts_src = np.array([
    [202, 320],     # top left corner
    [156, 422],      # bottom left corner
    [613, 378],     # bottom right corner
    [501, 304]      # top right corner
])
